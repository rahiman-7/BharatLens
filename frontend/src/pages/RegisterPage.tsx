      ...
      <div className="max-w-md w-full space-y-8 bg-white dark:bg-stone-900 p-8 rounded-2xl border border-stone-200 dark:border-stone-800 shadow-xl">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-stone-600 dark:text-stone-400">
            Join BharatLens for bookmarking and smart news intelligence
          </p>
        </div>
        ...
        <form className="mt-8 space-y-4" onSubmit={handleSubmit}>
          ...
          <div className="text-xs text-stone-500 dark:text-stone-400 flex items-center gap-1.5 pt-1">
            <CheckCircle2 className="w-4 h-4 text-emerald-600 dark:text-emerald-400 flex-shrink-0" />
            <span>Zero onboarding questionnaire — read freely and we learn seamlessly</span>
          </div>
